...
//	}
    ...
    public static class Utils {
        ...
        substrBefore(final String str, final String separator) {
         ...
         */
        public static String
        substrAfter(final String str, final String separator) {
            if (!notBlank(str)) {
                return str;
            }
            if (separator == null) {
        ...
        /**
         * for SQL.
         * WARN: cannot guarantee SQL Injection, use with caution
         * @param param
         */
        public static final String quote(final String param) {
            int paraLen = param.length();
            StringBuilder buf = new StringBuilder(paraLen * 6 / 5);
            quoteTo(buf, param);
            return buf.toString();
        }
         ...
         * @param param
         */
        public static final void quoteTo(Appendable buf, String param) {
            int paraLen = param.length();
            try {
                buf.append('\'');
                //
    ...
    public static class Codec {
        ...
        public static char[] toHexChars(byte[] bytes) {
            ...
            for ( int j = 0; j < bytes.length; j++ ) {
                int v = bytes[j] & 0xFF;
                int idx = j * 2;
                hexChars[idx] = HEX_CHARS[v >>> 4];
                hexChars[idx + 1] = HEX_CHARS[v & 0x0F];
            }
            return hexChars;
        }
        public static byte[] fromHexStr(String s) {
            return fromHexChars(s.toCharArray());
        }
